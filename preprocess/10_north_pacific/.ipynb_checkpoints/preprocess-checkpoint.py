...
# paths to dataset
PATH_2d = '/scratch/ab10313/pleiades/10_north_pacific/2d_data/'
PATH_3d = '/scratch/ab10313/pleiades/10_north_pacific/3d_data/'

# make diirectory for preprocessed variables
PATH_PP = '/scratch/ab10313/pleiades/10_north_pacific/preprcossed_data/'
os.mkdir(PATH_PP)
