...
PATH_LIST_2d = glob.glob(BASE+'12_agulhas_smooth/2d_data/')
PATH_LIST_3d = glob.glob(BASE+'12_agulhas_smooth/3d_data/')
PATH_LIST_PP = glob.glob(BASE+'12_agulhas_smooth/preprcossed_data/')
