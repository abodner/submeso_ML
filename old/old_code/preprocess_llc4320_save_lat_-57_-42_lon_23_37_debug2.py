...
Um_MLD = Um.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Um_MLD').chunk(chunks={"time":1, "j":Um.j.size, "i": Um.i.size})
Vm_MLD = Vm.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Vm_MLD').chunk(chunks={"time":1, "j":Um.j.size, "i": Um.i.size})
Wm_MLD = Wm.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Wm_MLD').chunk(chunks={"time":1, "j":Um.j.size, "i": Um.i.size})
Bm_MLD = Bm.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Bm_MLD').chunk(chunks={"time":1, "j":Um.j.size, "i": Um.i.size})
del Um, Vm, Wm, Bm

# submeso fluxes MLD average
UsBs_MLD = UsBs.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('UsBs_MLD').chunk(chunks={"time":1, "j":UsBs.j.size, "i": UsBs.i.size})
VsBs_MLD = VsBs.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('VsBs_MLD').chunk(chunks={"time":1, "j":UsBs.j.size, "i": UsBs.i.size})
WsBs_MLD = WsBs.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('WsBs_MLD').chunk(chunks={"time":1, "j":UsBs.j.size, "i": UsBs.i.size})
del UsBs, VsBs, WsBs

# meso gradients MLD average
Bm_x_MLD = Bm_x.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Bm_x_MLD').chunk(chunks={"time":1, "j":Bm_x.j.size, "i": Bm_x.i.size})
Bm_y_MLD = Bm_y.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Bm_y_MLD').chunk(chunks={"time":1, "j":Bm_x.j.size, "i": Bm_x.i.size})
Bm_z_MLD = Bm_z.where(delta_sigma<=0.03).mean(dim="k",skipna=True).rename('Bm_z_MLD').chunk(chunks={"time":1, "j":Bm_x.j.size, "i": Bm_x.i.size})
del Bm_x, Bm_y, Bm_z
...
print('meso fields')
Um_MLD_lowres.to_netcdf(PATH+'data/Um_MLD_lowres.nc',engine='h5netcdf')
Vm_MLD_lowres.to_netcdf(PATH+'data/Vm_MLD_lowres.nc',engine='h5netcdf')
Wm_MLD_lowres.to_netcdf(PATH+'data/Wm_MLD_lowres.nc',engine='h5netcdf')
Bm_MLD_lowres.to_netcdf(PATH+'data/Bm_MLD_lowres.nc',engine='h5netcdf')

print('submeso fluxes')
UsBs_MLD_lowres.to_netcdf(PATH+'data/UsBs_MLD_lowres.nc',engine='h5netcdf')
VsBs_MLD_lowres.to_netcdf(PATH+'data/VsBs_MLD_lowres.nc',engine='h5netcdf')
WsBs_MLD_lowres.to_netcdf(PATH+'data/WsBs_MLD_lowres.nc',engine='h5netcdf')

print('meso B grad')
Bm_x_MLD_lowres.to_netcdf(PATH+'data/Bm_x_MLD_lowres.nc',engine='h5netcdf')
Bm_y_MLD_lowres.to_netcdf(PATH+'data/Bm_y_MLD_lowres.nc',engine='h5netcdf')
Bm_z_MLD_lowres.to_netcdf(PATH+'data/Bm_z_MLD_lowres.nc',engine='h5netcdf')
'''
